...
# Setup Static IP to 192.168.50.200
# Change allow-hotplug ens18 to auto ens18
# Change iface ens18 inet dhcp to iface ens18 inet static
# Add address 192.168.50.200
# Add netmask 255.255.255.0
# Add gateway 192.168.50.254
# Add dns-nameservers 192.168.51.53
